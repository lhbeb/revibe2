                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#025156] focus:border-transparent"
                        disabled={isSending}
                      />
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        required
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#025156] focus:border-transparent bg-white"
                        disabled={isSending}
                      >
                    ...
                    <button
                      type="submit"
                      className={`w-full bg-[#025156] hover:bg-[#013d40] text-white font-medium py-3 rounded-lg transition-colors duration-300 ${isSending ? 'opacity-60 cursor-not-allowed' : ''}`}
                      disabled={isSending}
                    >
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start">
                      <MapPin className="h-6 w-6 text-[#025156] mt-1" />
                      <div className="ml-4">
                    ...
                    <div className="flex items-start">
                      <Phone className="h-6 w-6 text-[#025156] mt-1" />
                      <div className="ml-4">
                    ...
                    <div className="flex items-start">
                      <Mail className="h-6 w-6 text-[#025156] mt-1" />
                      <div className="ml-4">
