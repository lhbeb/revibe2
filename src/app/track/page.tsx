          ...
          <div className="max-w-xl mx-auto">
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
              <input
                ...
                maxLength={50}
                className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#025156] focus:border-transparent"
              />
              <button
                onClick={handleTrack}
                disabled={!isScriptLoaded}
                className="px-8 py-3 bg-[#025156] hover:bg-[#013d40] text-white font-medium rounded-lg transition-colors duration-300 disabled:bg-gray-400 disabled:cursor-not-allowed"
              >
                Track Package
              </button>
            </div>
