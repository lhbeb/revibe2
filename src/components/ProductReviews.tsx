              ...
              {Object.entries(ratingDistribution).reverse().map(([rating, percentage]) => (
                <div key={rating} className="flex items-center gap-2 mb-2">
                  ...
                  <div className="flex-grow bg-gray-200 rounded-full h-2">
                    <div 
                      className="bg-[#025156] rounded-full h-2" 
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="relative">
              <select
                ...
                className="appearance-none bg-white border border-gray-300 rounded-lg px-4 py-2 pr-8 text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#025156] focus:border-transparent"
              >
                ...
                <div className="flex-grow">
                  <div className="flex items-start justify-between mb-2">
                    <div>
                      <h3 className="font-medium text-gray-900 flex items-center gap-2 flex-wrap sm:flex-nowrap">
                        {review.author}
                        {review.verified && (
                          <span className="flex items-center text-[#025156] text-sm">
                  ...
                  <div className="flex mb-2">
                    {[...Array(5)].map((_, i) => (
                      <Star 
                        key={i}
                        className={`h-4 w-4 ${i < review.rating ? 'text-[#025156] fill-[#025156]' : 'text-gray-300'}`}
                      />
                    ))}
                  </div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {review.images.map((image, index) => (
                          <button
                            ...
                            className="relative group overflow-hidden rounded-lg border border-gray-200 hover:border-[#025156] transition-colors duration-200"
                          >
                            <Image
                              src={image}
